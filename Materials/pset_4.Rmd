...
dat <- read_dta('../NFGH/Quant I Fall 2013 for JB/Quant I Fall 2013 for JB/problem sets/cpsnov2012.dta')
...
Now repeat this process. But this time choose $x$, $y$ and $z$ that illustrate how omitting a variable $z$ can bias estimates of $\beta _{1}$ in a *negative* direction.
